...
function ScrollableTraceBody({
  children,
  autoScroll,
  className = "ml-5 mr-3 mt-0.5 max-h-[180px] overflow-y-auto px-3 py-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden",
}: {
  ...
  const Icon =
    kind === "rag_retrieval"
      ...
      : kind === "llm_final_response"
        ? MessageSquare
        : kind === "llm_observation" || kind === "llm_reasoning"
          ? Lightbulb
        : kind === "llm_generation"
          ? PenLine
        : phase === "writing"
          ...
          return (
            ...
            >
              ...
              <ScrollableTraceBody
                ...
                className="ml-5 mr-3 mt-0.5 max-h-[280px] overflow-y-auto px-3 py-1 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden"
              >
                <div className="text-[11px] italic leading-[1.6] text-[var(--muted-foreground)]">
