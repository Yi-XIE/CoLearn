    ...
    >
      ...
      >
        ...
        {(title || titleIcon || showCloseButton) && (
          <div
            className={`p-4 border-b border-[var(--border)] flex items-center justify-between shrink-0 ${headerClassName}`}
          >
        ...
        {/* Footer */}
        {footer && (
          <div className={`p-4 border-t border-[var(--border)] shrink-0 ${footerClassName}`}>
            {footer}
          </div>
        )}
      </div>
